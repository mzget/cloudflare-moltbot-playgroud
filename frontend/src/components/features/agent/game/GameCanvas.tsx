...
const INITIAL_NPCS: NPC[] = [
  ...
  },
  {
    ...
    metadata: { type: 'llm-task', endpoint: '/api/test-facebook-post', triggerLabel: 'Format Post', method: 'POST', schedule: 'Every 30min' },
  },
  {
  ...
  },
  {
    ...
    responsibility: 'Sends Email Reports', dialogue: ['Cron: Every 6 hours (DISABLED)', 'Job: Format reports as HTML email.', 'Currently disabled in scheduled worker.'],
    isSolid: true, animationType: 'bounce',
    metadata: { type: 'scheduled-job', endpoint: '/api/email-test', triggerLabel: 'Send Email', schedule: 'DISABLED' },
  },
  {
  ...
  },
  {
    ...
    responsibility: 'Publish FB Posts', dialogue: ['Cron: */30 * * * * (Every 30 min)', 'Job: Process pending FB posts from queue.', 'Gemma-3 12B model. Own dedicated cron.'],
    isSolid: true, animationType: 'bounce',
    metadata: { type: 'scheduled-job', endpoint: '/api/test-facebook-post', triggerLabel: 'Format Post', method: 'POST', schedule: 'Every 30min' },
  },
];
