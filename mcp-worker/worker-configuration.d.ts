/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 98fb500ebdad0db2f719df26f18ed552)
// Runtime types generated with workerd@1.20260430.1 2024-11-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OaktreeMCP" | "OaktreeChat";
	}
	interface Env {
		BUCKET: R2Bucket;
		DB: D1Database;
		...
		ENABLE_DATABASE_AGENT: "false";
		chat_ai_model: "@cf/google/gemma-4-26b-a4b-it";
		db_ai_model: "@cf/meta/llama-3-8b-instruct";
		IS_LOCAL: string;
		OAKTREE_MCP: DurableObjectNamespace<import("./src/index").OaktreeMCP>;
		OAKTREE_CHAT: DurableObjectNamespace<import("./src/index").OaktreeChat>;
	}
}
